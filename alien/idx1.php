...
@font-face {
  ...
  src: local('http://localhost/alien/lib/css/leaguegothic-webfont'), url('http://localhost/alien/lib/css/leaguegothic-webfont.ttf') format('truetype');
}
* {
  margin: 0;
  padding: 0;
...
.web20 header.title h1 {
  ...
  font: 40pt 'leaguegothic-webfont';
}
nav li {
  list-style: none;
  float: left;
...
<script>
  function getTasks(query) {
    ...
    var DB = "http://localhost:5984/alien";


        $.ajax({
            url: DB+'/_design/base/_view/articles?reduce=false&start_key=["'+query+'"]&end_key=["'+query+'ZZZ"]',
           // url: DATABASE + "/_design/tasks/_view/articles",
            beforeSend:function(){
            },
...
<body class="web20" onload='alert(getTasks("power"))';>
  <div id="wrapper">



    <header class="title"><h1>The Daily Times</h1></header>
      ...
      <article>
        <div class="text1">
          <header>
            ...
            <p>By: Eric Bidelman</p>
          </header>
          <p>

click any item

headings  categorys lists related
Internal structure
Surface geology
...
Equator
Radius
Solar_System_objects_by_radius
moons_by_diameter
Natural_satellite
Ganymede_(moon)
Titan_(moon)
...
Drag_(physics)
          ...
          <!-- <p>Aliquam erat volutpat. Donec libero arcu,tempor non consectetur nec, placerat ut sapien.
            ...
            felis, at molestie risus. Nunc ut nibh magna

Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus auctor, nisi at ornare fermentum, libero
    ...
    <footer>
      <p>Copyright 2010 <a href="http://example.com">The Daily Times Company</a></p>
    </footer>
  </div>
